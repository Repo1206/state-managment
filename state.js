...
export class StandingLeft extends State {
  ...
  handleInput(input) {
    if (input === "PRESS right")
      this.player.setState(states.RUNNING_RIGHT); //set state to StandingRight
...
export class StandingRight extends State {
  ...
  handleInput(input) {
    if (input === "PRESS left")
      this.player.setState(states.RUNNING_LEFT); //set state to StandingLeft
...
export class RunningLeft extends State {
  ...
  handleInput(input) {
    if (input === "PRESS right")
      this.player.setState(states.RUNNING_RIGHT); //set state to RunningRight
...
export class RunningRight extends State {
  ...
  handleInput(input) {
    if (input === "PRESS left")
      this.player.setState(states.RUNNING_LEFT); //set state to RunningLeft
